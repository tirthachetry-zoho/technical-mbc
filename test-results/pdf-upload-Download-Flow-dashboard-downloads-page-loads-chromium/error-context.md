...
- Name: pdf-upload.spec.ts >> Download Flow >> dashboard downloads page loads
- Location: e2e/pdf-upload.spec.ts:298:7
...
Call log:
  - navigating to "http://localhost:3000/dashboard/downloads", waiting until "load"
